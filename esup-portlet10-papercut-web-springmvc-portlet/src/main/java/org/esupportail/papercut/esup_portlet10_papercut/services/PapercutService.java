 ...
 */
package org.esupportail.papercut.esup_portlet10_papercut.services;

import java.util.Vector;

import org.apache.log4j.Logger;
import org.esupportail.papercut.esup_portlet10_papercut.domain.UserPapercutInfos;
import org.esupportail.papercut.esup_portlet10_papercut.papercutapi.ServerCommandProxy;
...
public class PapercutService implements InitializingBean {
    ...
    public UserPapercutInfos getUserPapercutInfos(String uid) {
    	log.debug("L'utilisateur  " + uid + " existe-til sur le serveur papercut " + serverProxy.isUserExists(uid));
